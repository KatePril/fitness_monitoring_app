class HistoricalDataSelector:
    ...
    def select_last_month_data(self, user_id):
        self.cursor.execute(self.SELECT_LAST_MONTH_STATISTICS, (user_id,))
        return self.cursor.fetchall()

    def select_last_year_data(self, user_id):
        self.cursor.execute(self.SELECT_LAST_YEAR_STATISTICS, (user_id,))
        return self.cursor.fetchall()
